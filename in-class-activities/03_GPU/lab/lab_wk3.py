...
# YOUR CODE HERE
mean_dev = cp.mean(cp.asarray(arr_host))
...
# YOUR CODE HERE
squared_deviations_dev = cp.square(cp.asarray(arr_host) - mean_dev)
...
# YOUR CODE HERE
variance_dev = cp.mean(squared_deviations_dev)
...
# YOUR CODE HERE
mean_host = cp.asnumpy(mean_dev)
variance_host = cp.asnumpy(variance_dev)
